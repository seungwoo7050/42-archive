...
Brutalist renderer가 oversized grid, explicit state, high-contrast action, project evidence, responsive/print rules와 one-route entry를 완성하는 과정을 복원합니다.

### 계획된 핵심 invariant

- `Brutalist design system construction`의 주요 결정은 route/design/component마다 중복 해석되지 않고 명시된 owner에 위치합니다.
...
| ---: | --- | --- | :---: | --- | --- |
| 1 | `162542118ba4` | style(brutalist): 화면 토큰과 brand mark 구성 | B | RENDERER | 초기 상태와 vocabulary를 고정합니다. |
| 2 | `a2539ef309d1` | style(brutalist): header 상태와 home hero 구성 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 3 | `75913149fe24` | style(brutalist): 주요 action과 section 경계 구성 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 4 | `aaf26e755213` | style(brutalist): 원칙 카드와 contact band 구성 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 5 | `bb5008a8c7b3` | style(brutalist): 다음 프로젝트와 focus card 구성 | B | RENDERER, A11Y | 기능·책임 경계를 확장합니다. |
| 6 | `b170c73a36d0` | style(brutalist): footer metadata와 blink 동작 구성 | B | RENDERER, SEO | 기능·책임 경계를 확장합니다. |
| 7 | `f810c49022be` | style(brutalist): tablet grid 재배치 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 8 | `b57da6a41419` | style(brutalist): mobile header와 hero 구성 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 9 | `077ff3d49f30` | style(brutalist): 소형 화면과 인쇄 경계 구성 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 10 | `caa7df81d899` | feat(brutalist): 모든 route를 renderer에 통합 | A | ARCH, ROUTING, RENDERER | 기능·책임 경계를 확장합니다. |
| 11 | `dd71d28143a8` | feat(designs): Brutalist renderer 활성화 | A | ARCH, RENDERER | Thread의 통합·검증 상태를 확인합니다. |
...
- `162542118ba4^`와 `162542118ba4`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
...
- 먼저 `162542118ba4^`와 `162542118ba4`를 비교합니다.
...
- `a2539ef309d1^`와 `a2539ef309d1`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `a2539ef309d1^`와 `a2539ef309d1`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 3. `75913149fe24` — style(brutalist): 주요 action과 section 경계 구성
...
- `75913149fe24^`와 `75913149fe24`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `75913149fe24^`와 `75913149fe24`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 4. `aaf26e755213` — style(brutalist): 원칙 카드와 contact band 구성
...
- `aaf26e755213^`와 `aaf26e755213`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `aaf26e755213^`와 `aaf26e755213`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 5. `bb5008a8c7b3` — style(brutalist): 다음 프로젝트와 focus card 구성
...
- `bb5008a8c7b3^`와 `bb5008a8c7b3`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `bb5008a8c7b3^`와 `bb5008a8c7b3`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 6. `b170c73a36d0` — style(brutalist): footer metadata와 blink 동작 구성
...
- `b170c73a36d0^`와 `b170c73a36d0`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `b170c73a36d0^`와 `b170c73a36d0`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 7. `f810c49022be` — style(brutalist): tablet grid 재배치
...
- `f810c49022be^`와 `f810c49022be`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `f810c49022be^`와 `f810c49022be`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 8. `b57da6a41419` — style(brutalist): mobile header와 hero 구성
...
- `b57da6a41419^`와 `b57da6a41419`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `b57da6a41419^`와 `b57da6a41419`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 9. `077ff3d49f30` — style(brutalist): 소형 화면과 인쇄 경계 구성
...
- `077ff3d49f30^`와 `077ff3d49f30`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- 적용 selector, token, breakpoint, motion/focus/semantics 영향과 DOM contract를 확인합니다.
- Visual change가 interaction 또는 accessibility invariant를 바꾸는지 구분합니다.
...
- 먼저 `077ff3d49f30^`와 `077ff3d49f30`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 10. `caa7df81d899` — feat(brutalist): 모든 route를 renderer에 통합
...
- `caa7df81d899^`와 `caa7df81d899`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
...
- 먼저 `caa7df81d899^`와 `caa7df81d899`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 11. `dd71d28143a8` — feat(designs): Brutalist renderer 활성화
...
- `dd71d28143a8^`와 `dd71d28143a8`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `dd71d28143a8^`와 `dd71d28143a8`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
| --- | --- | --- | --- | --- |
| `Brutalist design system construction`의 핵심 결정은 한 owner가 수행합니다. |  |  |  |  |
