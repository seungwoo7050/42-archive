...
초기 두 template가 shared pages에서 독립 full-route renderer와 exhaustive dispatcher로 이동하는 과정을 복원합니다.

### 계획된 핵심 invariant

- `Design and Classic renderer extraction`의 주요 결정은 route/design/component마다 중복 해석되지 않고 명시된 owner에 위치합니다.
...
| ---: | --- | --- | :---: | --- | --- |
| 1 | `4732301a7d2c` | style(designs): route renderer 디자인 토큰 확장 | A | ARCH, ROUTING, RENDERER | 초기 상태와 vocabulary를 고정합니다. |
| 2 | `969741c3469d` | refactor(shell): 디자인 renderer 셸 경계 추가 | A | ARCH, ROUTING, RENDERER | 기능·책임 경계를 확장합니다. |
| 3 | `b8d35db40ed1` | refactor(routes): Design 홈 renderer로 위임 | B | ROUTING, RENDERER, REFACTOR | 기능·책임 경계를 확장합니다. |
| 4 | `29943a185465` | refactor(routes): Design 프로젝트 목록 renderer로 위임 | B | ROUTING, RENDERER, REFACTOR | 기능·책임 경계를 확장합니다. |
| 5 | `05e1cebd0b70` | refactor(design): Design route dispatcher 추가 | A | ARCH, ROUTING, RENDERER | 기능·책임 경계를 확장합니다. |
| 6 | `15ab994dabfd` | refactor(classic-home): 홈 renderer를 독립 모듈로 이동 | B | RENDERER, REFACTOR | 기능·책임 경계를 확장합니다. |
| 7 | `7a65f0522061` | refactor(classic-project): 상세 renderer를 독립 모듈로 완성 | B | RENDERER, REFACTOR | 기능·책임 경계를 확장합니다. |
| 8 | `6b193d084e69` | refactor(classic): Classic route dispatcher 추가 | A | ARCH, ROUTING, RENDERER | Thread의 통합·검증 상태를 확인합니다. |

## 5. Commit별 학습 기록

각 section은 반드시 해당 SHA의 tree와 parent diff를 기준으로 작성합니다. 같은 commit이 다른 확장 thread에 다시 등장해도 이 thread의 관점에서 별도로 확인합니다.

### 1. `4732301a7d2c` — style(designs): route renderer 디자인 토큰 확장
...
- `4732301a7d2c^`와 `4732301a7d2c`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
...
- 먼저 `4732301a7d2c^`와 `4732301a7d2c`를 비교합니다.
...
### 2. `969741c3469d` — refactor(shell): 디자인 renderer 셸 경계 추가
...
- `969741c3469d^`와 `969741c3469d`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
...
- 먼저 `969741c3469d^`와 `969741c3469d`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 3. `b8d35db40ed1` — refactor(routes): Design 홈 renderer로 위임
...
- `b8d35db40ed1^`와 `b8d35db40ed1`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Refactor 전후 responsibility와 runtime payload/import/call graph 변화를 비교합니다.
- Compatibility branch와 제거 조건, behavior-preservation evidence를 확인합니다.
...
- 먼저 `b8d35db40ed1^`와 `b8d35db40ed1`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 4. `29943a185465` — refactor(routes): Design 프로젝트 목록 renderer로 위임
...
- `29943a185465^`와 `29943a185465`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Refactor 전후 responsibility와 runtime payload/import/call graph 변화를 비교합니다.
- Compatibility branch와 제거 조건, behavior-preservation evidence를 확인합니다.
...
- 먼저 `29943a185465^`와 `29943a185465`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 5. `05e1cebd0b70` — refactor(design): Design route dispatcher 추가
...
- `05e1cebd0b70^`와 `05e1cebd0b70`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Refactor 전후 responsibility와 runtime payload/import/call graph 변화를 비교합니다.
- Compatibility branch와 제거 조건, behavior-preservation evidence를 확인합니다.
...
- 먼저 `05e1cebd0b70^`와 `05e1cebd0b70`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 6. `15ab994dabfd` — refactor(classic-home): 홈 renderer를 독립 모듈로 이동
...
- `15ab994dabfd^`와 `15ab994dabfd`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Refactor 전후 responsibility와 runtime payload/import/call graph 변화를 비교합니다.
- Compatibility branch와 제거 조건, behavior-preservation evidence를 확인합니다.
...
- 먼저 `15ab994dabfd^`와 `15ab994dabfd`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 7. `7a65f0522061` — refactor(classic-project): 상세 renderer를 독립 모듈로 완성
...
- `7a65f0522061^`와 `7a65f0522061`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Refactor 전후 responsibility와 runtime payload/import/call graph 변화를 비교합니다.
- Compatibility branch와 제거 조건, behavior-preservation evidence를 확인합니다.
...
- 먼저 `7a65f0522061^`와 `7a65f0522061`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 8. `6b193d084e69` — refactor(classic): Classic route dispatcher 추가
...
- `6b193d084e69^`와 `6b193d084e69`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Refactor 전후 responsibility와 runtime payload/import/call graph 변화를 비교합니다.
- Compatibility branch와 제거 조건, behavior-preservation evidence를 확인합니다.
...
- 먼저 `6b193d084e69^`와 `6b193d084e69`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
| --- | --- | --- | --- | --- |
| `Design and Classic renderer extraction`의 핵심 결정은 한 owner가 수행합니다. |  |  |  |  |
