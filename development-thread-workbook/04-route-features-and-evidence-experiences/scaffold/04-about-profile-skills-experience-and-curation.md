# Thread: About: profile, skills, experience, and curation
...
About route가 identity와 principles에서 시작해 journey, skills, experience와 project-backed curation rationale까지 확장되는 과정을 복원합니다.

### 계획된 핵심 invariant

- `About: profile, skills, experience, and curation`의 주요 결정은 route/design/component마다 중복 해석되지 않고 명시된 owner에 위치합니다.
...
| ---: | --- | --- | :---: | --- | --- |
| 1 | `7fe913796acb` | feat(about): 프로필과 원칙 소개 추가 | B | RENDERER | 초기 상태와 vocabulary를 고정합니다. |
| 2 | `edf8e75716a3` | feat(about): 여정 요약 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 3 | `bea99bce4478` | feat(about): 기술 그룹 소개 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 4 | `a00a6bf1af58` | feat(about): 프로필 사진 소개 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 5 | `4b9c2894a756` | feat(about): 기술 집중 영역 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 6 | `a7723eb193eb` | feat(about): 경력 목록 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 7 | `924bcd75aade` | feat(about): 큐레이션 기준 소개 추가 | B | CONTENT, RENDERER | 기능·책임 경계를 확장합니다. |
| 8 | `80903ec6197f` | feat(about): 큐레이션 프로젝트 범주 추가 | B | CONTENT, RENDERER | 기능·책임 경계를 확장합니다. |
| 9 | `a65f27363837` | feat(about): 큐레이션 공백과 재검토 추가 | B | CONTENT, RENDERER | Thread의 통합·검증 상태를 확인합니다. |
...
- `7fe913796acb^`와 `7fe913796acb`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
...
- 먼저 `7fe913796acb^`와 `7fe913796acb`를 비교합니다.
...
### 2. `edf8e75716a3` — feat(about): 여정 요약 추가
...
- `edf8e75716a3^`와 `edf8e75716a3`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `edf8e75716a3^`와 `edf8e75716a3`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 3. `bea99bce4478` — feat(about): 기술 그룹 소개 추가
...
- `bea99bce4478^`와 `bea99bce4478`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `bea99bce4478^`와 `bea99bce4478`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 4. `a00a6bf1af58` — feat(about): 프로필 사진 소개 추가
...
- `a00a6bf1af58^`와 `a00a6bf1af58`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `a00a6bf1af58^`와 `a00a6bf1af58`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 5. `4b9c2894a756` — feat(about): 기술 집중 영역 추가
...
- `4b9c2894a756^`와 `4b9c2894a756`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `4b9c2894a756^`와 `4b9c2894a756`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 6. `a7723eb193eb` — feat(about): 경력 목록 추가
...
- `a7723eb193eb^`와 `a7723eb193eb`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `a7723eb193eb^`와 `a7723eb193eb`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 7. `924bcd75aade` — feat(about): 큐레이션 기준 소개 추가
...
- `924bcd75aade^`와 `924bcd75aade`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `924bcd75aade^`와 `924bcd75aade`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 8. `80903ec6197f` — feat(about): 큐레이션 프로젝트 범주 추가
...
- `80903ec6197f^`와 `80903ec6197f`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `80903ec6197f^`와 `80903ec6197f`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 9. `a65f27363837` — feat(about): 큐레이션 공백과 재검토 추가
...
- `a65f27363837^`와 `a65f27363837`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `a65f27363837^`와 `a65f27363837`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
| --- | --- | --- | --- | --- |
| `About: profile, skills, experience, and curation`의 핵심 결정은 한 owner가 수행합니다. |  |  |  |  |
