# Thread: Project index grouping and dual presentation
...
Project grouping, featured/archive partition과 metrics를 Design/Classic index가 서로 다른 정보 밀도로 표현하는 과정을 복원합니다.

### 계획된 핵심 invariant

- `Project index grouping and dual presentation`의 주요 결정은 route/design/component마다 중복 해석되지 않고 명시된 owner에 위치합니다.
...
| ---: | --- | --- | :---: | --- | --- |
| 1 | `e3fc25f46b42` | feat(projects): 프로젝트 그룹 정렬 규칙 추가 | B | RENDERER | 초기 상태와 vocabulary를 고정합니다. |
| 2 | `cd2eac06b220` | feat(projects): 디자인 프로젝트 소개 영역 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 3 | `e547aafcb77a` | feat(projects): 디자인 대표 프로젝트 목록 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 4 | `8f67e1990157` | feat(projects): 디자인 프로젝트 그룹 목록 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 5 | `6d5b1dbbd3ae` | feat(projects): 클래식 프로젝트 소개와 터미널 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 6 | `b7ed48a4d77c` | feat(projects): 클래식 대표 프로젝트 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 7 | `76a3155e757d` | feat(projects): 클래식 그룹 인덱스 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 8 | `7571f1400065` | feat(projects): 프로젝트 목록 route 연결 | B | ROUTING, RENDERER | Thread의 통합·검증 상태를 확인합니다. |

## 5. Commit별 학습 기록

각 section은 반드시 해당 SHA의 tree와 parent diff를 기준으로 작성합니다. 같은 commit이 다른 확장 thread에 다시 등장해도 이 thread의 관점에서 별도로 확인합니다.

### 1. `e3fc25f46b42` — feat(projects): 프로젝트 그룹 정렬 규칙 추가
...
- `e3fc25f46b42^`와 `e3fc25f46b42`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
...
- 먼저 `e3fc25f46b42^`와 `e3fc25f46b42`를 비교합니다.
...
### 2. `cd2eac06b220` — feat(projects): 디자인 프로젝트 소개 영역 추가
...
- `cd2eac06b220^`와 `cd2eac06b220`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `cd2eac06b220^`와 `cd2eac06b220`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 3. `e547aafcb77a` — feat(projects): 디자인 대표 프로젝트 목록 추가
...
- `e547aafcb77a^`와 `e547aafcb77a`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `e547aafcb77a^`와 `e547aafcb77a`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 4. `8f67e1990157` — feat(projects): 디자인 프로젝트 그룹 목록 추가
...
- `8f67e1990157^`와 `8f67e1990157`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `8f67e1990157^`와 `8f67e1990157`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 5. `6d5b1dbbd3ae` — feat(projects): 클래식 프로젝트 소개와 터미널 추가
...
- `6d5b1dbbd3ae^`와 `6d5b1dbbd3ae`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `6d5b1dbbd3ae^`와 `6d5b1dbbd3ae`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 6. `b7ed48a4d77c` — feat(projects): 클래식 대표 프로젝트 추가
...
- `b7ed48a4d77c^`와 `b7ed48a4d77c`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `b7ed48a4d77c^`와 `b7ed48a4d77c`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 7. `76a3155e757d` — feat(projects): 클래식 그룹 인덱스 추가
...
- `76a3155e757d^`와 `76a3155e757d`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `76a3155e757d^`와 `76a3155e757d`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 8. `7571f1400065` — feat(projects): 프로젝트 목록 route 연결
...
- `7571f1400065^`와 `7571f1400065`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `7571f1400065^`와 `7571f1400065`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
| --- | --- | --- | --- | --- |
| `Project index grouping and dual presentation`의 핵심 결정은 한 owner가 수행합니다. |  |  |  |  |
