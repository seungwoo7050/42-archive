# Thread: Dual home composition and content-driven sections
...
Design/Classic home이 같은 domain content를 공유하면서 hero, featured projects, metrics, skills, journey와 contact를 서로 다른 composition으로 제공하는 과정을 복원합니다.

### 계획된 핵심 invariant

- `Dual home composition and content-driven sections`의 주요 결정은 route/design/component마다 중복 해석되지 않고 명시된 owner에 위치합니다.
...
| ---: | --- | --- | :---: | --- | --- |
| 1 | `3475ba3efdb2` | feat(home): 디자인 홈 소개 영역 구성 | B | RENDERER | 초기 상태와 vocabulary를 고정합니다. |
| 2 | `b027f42669aa` | feat(home): 대표 프로젝트 쇼케이스 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 3 | `07dd465dbe20` | feat(home): 디자인 대표 프로젝트 섹션 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 4 | `33bec9cf6325` | feat(home): 클래식 대표 프로젝트 섹션 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 5 | `afaf5a393518` | feat(home): 작업 지표 섹션 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 6 | `df26861cdc24` | feat(home): 기술 집중 영역 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 7 | `e3aebedaa46b` | feat(home): 선택 기술 스택 영역 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 8 | `9a107fe185cf` | feat(home): 공용 여정 섹션 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 9 | `bb8ccf341f39` | feat(home): 연락 미리보기 추가 | B | RENDERER | 기능·책임 경계를 확장합니다. |
| 10 | `92799407457e` | refactor(design-home): 홈 섹션 순서를 콘텐츠로 연결 | B | CONTENT, RENDERER, REFACTOR | Thread의 통합·검증 상태를 확인합니다. |

## 5. Commit별 학습 기록

각 section은 반드시 해당 SHA의 tree와 parent diff를 기준으로 작성합니다. 같은 commit이 다른 확장 thread에 다시 등장해도 이 thread의 관점에서 별도로 확인합니다.

### 1. `3475ba3efdb2` — feat(home): 디자인 홈 소개 영역 구성
...
- `3475ba3efdb2^`와 `3475ba3efdb2`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
...
- 먼저 `3475ba3efdb2^`와 `3475ba3efdb2`를 비교합니다.
...
- `b027f42669aa^`와 `b027f42669aa`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `b027f42669aa^`와 `b027f42669aa`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
- `07dd465dbe20^`와 `07dd465dbe20`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `07dd465dbe20^`와 `07dd465dbe20`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 4. `33bec9cf6325` — feat(home): 클래식 대표 프로젝트 섹션 추가
...
- `33bec9cf6325^`와 `33bec9cf6325`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `33bec9cf6325^`와 `33bec9cf6325`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 5. `afaf5a393518` — feat(home): 작업 지표 섹션 추가
...
- `afaf5a393518^`와 `afaf5a393518`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `afaf5a393518^`와 `afaf5a393518`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 6. `df26861cdc24` — feat(home): 기술 집중 영역 추가
...
- `df26861cdc24^`와 `df26861cdc24`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `df26861cdc24^`와 `df26861cdc24`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 7. `e3aebedaa46b` — feat(home): 선택 기술 스택 영역 추가
...
- `e3aebedaa46b^`와 `e3aebedaa46b`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `e3aebedaa46b^`와 `e3aebedaa46b`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 8. `9a107fe185cf` — feat(home): 공용 여정 섹션 추가
...
- `9a107fe185cf^`와 `9a107fe185cf`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `9a107fe185cf^`와 `9a107fe185cf`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 9. `bb8ccf341f39` — feat(home): 연락 미리보기 추가
...
- `bb8ccf341f39^`와 `bb8ccf341f39`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
- Commit이 추가한 입력, 출력, optional/disabled/unknown state와 integration point를 확인합니다.
- 이 SHA가 보장하는 범위와 후속 commit에 남긴 미완성 범위를 기록합니다.
...
- 먼저 `bb8ccf341f39^`와 `bb8ccf341f39`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
### 10. `92799407457e` — refactor(design-home): 홈 섹션 순서를 콘텐츠로 연결
...
- `92799407457e^`와 `92799407457e`의 first-parent diff에서 변경 파일과 핵심 symbol을 확인합니다.
- Resulting tree에서 새 symbol의 caller/callee와 data/state ownership을 추적합니다.
...
- 먼저 `92799407457e^`와 `92799407457e`를 비교합니다.
- Final HEAD의 helper, test, file layout을 이 commit에 소급하지 않습니다.
- 실행하지 않은 command 결과는 정적 검토와 구분합니다.
...
| --- | --- | --- | --- | --- |
| `Dual home composition and content-driven sections`의 핵심 결정은 한 owner가 수행합니다. |  |  |  |  |
